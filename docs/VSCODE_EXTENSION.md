...
Para un plugin JP v2, lee `META-INF/joss-symbols.json` del paquete e incorpora clases, métodos, parámetros y retornos al IntelliSense y al analyzer. Los JP antiguos sin ese archivo pueden ejecutarse, pero no ofrecen su API al editor.
