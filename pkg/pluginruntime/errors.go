...
var (
	...
	ErrClassNotFound         = errors.New("pluginruntime: clase no encontrada en el plugin")
	ErrMethodNotFound        = errors.New("pluginruntime: metodo no encontrado en la clase")
	ErrPermissionDenied      = errors.New("pluginruntime: permiso no concedido al plugin")
